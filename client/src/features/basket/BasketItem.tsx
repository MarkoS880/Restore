...
export default function BasketItem({ item }: Props) {
    ...
    return (
        <Paper sx={{
            ...
            <Box display='flex' alignItems='center'>
                ...
                <Box display='flex' flexDirection='column' gap={1}>
                    ...
                    <Grid2 container spacing={1} alignItems='center'>
                        <IconButton onClick={() => removeBasketItem({ productId: item.productId, quantity: 1 })} color='error' size="small" sx={{ border: 1, borderRadius: 1, midWidth: 0 }}>
                            <Remove/>
                        </IconButton>
            ...
            <IconButton onClick={() => removeBasketItem({ productId: item.productId, quantity: item.quantity })}  color='error' size="small" sx={{ border: 1, borderRadius: 1, midWidth: 0, alignSelf: 'start', marginRight:1, marginTop:1}}>
                <Close/>
            </IconButton>
        </Paper>
    )
